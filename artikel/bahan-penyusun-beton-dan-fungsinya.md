---
article_id: CON-02-01
title: "Peran Semen, Material Sementisius, Agregat, Air, dan Bahan Tambah dalam Beton"
slug: "bahan-penyusun-beton-dan-fungsinya"
...
final_route: "/artikel/bahan-penyusun-beton-dan-fungsinya.html"
...
# Peran Semen, Material Sementisius, Agregat, Air, dan Bahan Tambah dalam Beton

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Peran Semen, Material Sementisius, Agregat, Air, dan Bahan Tambah dalam Beton”
...
- **Scope boundary:** Explains roles without prescribing a recipe
- **Final public route:** `/artikel/bahan-penyusun-beton-dan-fungsinya.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Peran Semen, Material Sementisius, Agregat, Air, dan Bahan Tambah dalam Beton**.
...
- **Exact Markdown to insert:** `![Ilustrasi Semen Beton](/wp-content/uploads/2024/04/Semen-Beton.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Semen Beton` as relevant content media; no pixels were inspected.
...
- `/semen` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “Peran Semen, Material Sementisius, Agregat, Air, dan Bahan Tambah dalam Beton”.
