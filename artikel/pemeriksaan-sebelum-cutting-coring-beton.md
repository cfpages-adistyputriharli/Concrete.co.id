---
article_id: CON-09-05
title: "Cutting, Coring, dan Bobok Beton: Periksa Struktur dan Utilitas Sebelum Mulai"
slug: "pemeriksaan-sebelum-cutting-coring-beton"
...
date_modified: null
parent_topic: CON-09
primary_intent: "Safety checklist"
reader_community: "Concrete.co.id"
reader_address: "Kawan Concrete.co.id"
final_route: "/artikel/pemeriksaan-sebelum-cutting-coring-beton.html"
...
sources:
  ...
  - "https://www.ilo.org/sites/default/files/wcmsp5/groups/public/%40ed_dialogue/%40sector/documents/normativeinstrument/wcms_861584.pdf"
...
# Cutting, Coring, dan Bobok Beton: Periksa Struktur dan Utilitas Sebelum Mulai

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Cutting, Coring, dan Bobok Beton: Periksa Struktur dan Utilitas Sebelum Mulai”
...
- **Primary intent:** Safety checklist
...
- **Scope boundary:** Pre-work gates; no authorization to alter structure
- **Final public route:** `/artikel/pemeriksaan-sebelum-cutting-coring-beton.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Cutting, Coring, dan Bobok Beton: Periksa Struktur dan Utilitas Sebelum Mulai**.
...
- **Exact Markdown to insert:** `![Ilustrasi Jasa Coring Beton](/wp-content/uploads/2024/05/Jasa-Coring-Beton.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Jasa Coring Beton` as relevant content media; no pixels were inspected.
...
- `/jasa/cutting` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa/bobok` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- `CON-09-03` → `/artikel/pemadatan-beton-dan-risikonya.html` — Pemadatan Beton: Tujuan, Gejala Kekurangan, dan Risiko Berlebihan
- `CON-09-04` → `/artikel/prinsip-curing-beton.html` — Curing Beton: Menjaga Kondisi, Bukan Sekadar Menyiram Permukaan
- `CON-09-06` → `/artikel/keselamatan-kerja-dengan-beton.html` — Debu Silika, Beton Basah, dan Area Kerja: Risiko yang Harus Direncanakan
...
- **Tie back to this article:** Keep the explanation specific to “Cutting, Coring, dan Bobok Beton: Periksa Struktur dan Utilitas Sebelum Mulai”.
