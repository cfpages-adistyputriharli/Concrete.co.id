---
article_id: CON-09-01
title: "Batching Plant, Truck Mixer, dan Concrete Pump: Peran yang Sering Tercampur"
slug: "alur-batching-plant-truck-mixer-concrete-pump"
...
final_route: "/artikel/alur-batching-plant-truck-mixer-concrete-pump.html"
...
# Batching Plant, Truck Mixer, dan Concrete Pump: Peran yang Sering Tercampur

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Batching Plant, Truck Mixer, dan Concrete Pump: Peran yang Sering Tercampur”
...
- **Scope boundary:** Process roles; not machinery sales/specification duplication
- **Final public route:** `/artikel/alur-batching-plant-truck-mixer-concrete-pump.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Batching Plant, Truck Mixer, dan Concrete Pump: Peran yang Sering Tercampur**.
...
- `/mesin/truck-mixer` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/mesin/concrete-pump` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/mesin/batching-plant` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/mesin/trailer-pump` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/mesin/mortar-pump` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `CON-09-02` → `/artikel/cara-memilih-concrete-pump.html` — Memilih Concrete Pump dari Akses, Jangkauan, Campuran, dan Urutan Kerja
...
- **Tie back to this article:** Keep the explanation specific to “Batching Plant, Truck Mixer, dan Concrete Pump: Peran yang Sering Tercampur”.
